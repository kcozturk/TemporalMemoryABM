...
##### PARAMETERS #####
seed <- 10             # Set random seed for reproducibility. Based on this each simulation will have a unique seed
...
dynamic_inac_relationship <- "exp" #"linear" or "exp"
...
for (z in 1:total_combinations) {
  ...
  # Save results to CSV
  write.csv(output, file = paste0("Output/output_tradeoff_exp_decay", z, ".csv"))
}
...
for (z in 1:total_combinations) {
  ...
  # Save results to CSV
  write.csv(output, file = paste0("Output/output_tradeoff_exp_prod", z, ".csv"))
}
...
for (z in 1:total_combinations) {
  ...
  # Save results to CSV
  write.csv(output, file = paste0("Output/output_tradeoff_exp_hetero", z, ".csv"))
}
